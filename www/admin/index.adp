...
<div class="logger_body">
  ...
  <if @mappable_projects:rowcount@ gt 0>
    <p>
      <#_ Projects not in this logger application instance which can be linked in:#>
    </p>
  ...
  <ul class="action-links">
    <li><a href="@package_permissions_url@"><#_ Set permissions for this logger application instance#></a></li>
  </ul>

  <h2 class="logger">Help</h2>

  <p class="logger_font">
    <#_ The logger can track a number of <b>variables</b> in different <b>projects</b>#>.
  </p>

  <p class="logger_font">
    <#_ A <b>variable</b> is something you wish to track, for example:#>
  </p>
  ...
  <ul class="logger_font">
    ...
    <li>
      <#_ Expenses (currency, USD, EUR, whatever)#>
    </li>
    <li>
      <#_ Weight of goods shipped (lbs, kgs)#>
    </li>
    <li>
      <#_ Your personal weight (lbs, kgs). Non-additive.#>
    </li>
  </ul>

  <p class="logger_font">
    <#_ Variables are <b>shared between all projects</b>, so that you can
  ...
  <p class="logger_font">
    <#_ Some variables will be <b>additive</b>, meaning that it makes
  ...
  <p class="logger_font">
    <#_ You can mount multiple <b>instances of the logger
  ...
  <p class="logger_font">
    <#_ An example of why this is useful is if you work for a company,
